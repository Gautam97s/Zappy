          ...
          <div className="container px-4 py-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="text-xl font-semibold text-primary-foreground cursor-pointer">
                  Zappy
                </span>
              </div>
              ...
              <Button className="bg-white text-primary hover:bg-slate-800 hover:text-blue-200">
            ...
            <div className="mx-auto mt-16 max-w-3xl text-center">
              ...
              <div className="mt-8 flex justify-center gap-4">
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="border-blue-400  hover:bg-blue-900/50 hover:text-blue-200"
                >
                  Learn More
                </Button>
              </div>
